        ...
        <div className="acerca__contenido">
          <div>
            ...
            <p className="acerca__texto">
              ...
              apasionado por el área de las IT, actualmente me enfoco en el área
              del Desarrollo Web con el deseo de aprender y mejorar día a día
              mis habilidades en este maravilloso mundo del Desarrollo de
              Software
            </p>
          </div>
          <div>
            ...
            <p className="acerca__texto">
              Me considero una persona muy perseverante cuando quiero lograr mis
              objetivos, y la Tecnología es uno de ellos.
            </p>
          </div>
          <div>
